...
export const projectsList = [
  ...
  },
  {
    ...
    skills: "OpenAI API, Express.js, JS, TypeScript, Sass(SCSS), HTML5, BEM Methodology, React, Context API, React Router, Figma design",
    link: "https://vk-workshop.github.io/ai-assistant/",
    img: project71,
    imgBig: project7,
    gitHubLink: "https://github.com/vk-workshop/ai-assistant",
  },
  {
    id: v1(),
    title: "Dino Game",
